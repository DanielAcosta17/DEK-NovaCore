  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 flex flex-col transition-colors">
      ...
      <div className="bg-white dark:bg-slate-850 border-b border-slate-200 dark:border-slate-800 shadow-sm py-3 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3 text-xs text-slate-600 dark:text-slate-300">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 w-full space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="relative max-w-md w-full">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#253745] dark:focus:ring-blue-400 shadow-sm"
            />
          </div>
        ...
        {filteredProducts.length === 0 ? (
          <div className="py-16 text-center space-y-3 bg-white dark:bg-slate-850 rounded-2xl border border-slate-200 dark:border-slate-800 p-8">
            ...
            <button
              ...
              className="text-xs font-bold text-[#253745] dark:text-blue-400 hover:underline"
            >
            ...
            {filteredProducts.map((prod) => {
              ...
              return (
                <div
                  ...
                  className="group cursor-pointer bg-white dark:bg-slate-850 rounded-2xl border border-slate-200 dark:border-slate-750 overflow-hidden shadow-sm hover:shadow-lg transition-all duration-200 hover:-translate-y-1 flex flex-col justify-between"
                >
                  <div>
                    {/* Image Box */}
                    <div className="relative h-44 sm:h-48 overflow-hidden bg-slate-100 dark:bg-slate-800">
                      ...
                      />
                      {prod.isFeatured && (
                        <span className="absolute top-2.5 left-2.5 px-2 py-0.5 text-[10px] font-extrabold bg-amber-500 text-white rounded-full shadow">
                          Destacado
                        </span>
                      )}
                      {prod.comparePrice && (
                    ...
                    <div className="p-4 space-y-2">
                      <div className="flex items-start justify-between gap-1">
                        <h3 className="font-bold text-xs sm:text-sm text-slate-900 dark:text-white line-clamp-1 group-hover:text-[#253745] dark:group-hover:text-blue-400 transition-colors">
                          {prod.name}
                        </h3>
                      </div>
                      ...
                      {prod.tags && prod.tags.length > 0 && (
                        <div className="flex flex-wrap gap-1 pt-1">
                          {prod.tags.slice(0, 2).map((t, idx) => (
                            <span
                              key={idx}
                              className="px-1.5 py-0.5 text-[9px] rounded bg-slate-100 dark:bg-slate-800 text-slate-500"
                            >
                              {t}
                            </span>
                          ))}
                    ...
                    <button
                      ...
                      className={`py-1.5 px-3 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all ${
                        isAdded
                          ...
                          : 'bg-slate-100 dark:bg-slate-800 hover:bg-[#253745] hover:text-white text-slate-800 dark:text-slate-200'
                      }`}
